"""
Django settings for cassette_playlist project.
...
SECRET_KEY = 'django-insecure--d_@@96#346)!-h5)1m3v*xn$ch%!fn$pp7r5=5etv^lmead(f'
...
AUTHENTICATION_BACKENDS = (
    'social_core.backends.kakao.KakaoOAuth2',  # 카카오 로그인 백엔드 추가
...
WSGI_APPLICATION = 'cassette_playlist.wsgi.application'
